...
# enflame vendor for moe_align_block_size: the atomic-cursor scatter
# breaks this backend (make_gcuir PassManager failure on tt.atomic_rmw), so a single deterministic program

...
# Enflame vendor: 1D grid with 65535 fold and no runtime early-return
# branches (T12-validated Enflame-safe kernel structure); rank-0 adapters
# and empty segments contribute zero via scaling instead of returning.

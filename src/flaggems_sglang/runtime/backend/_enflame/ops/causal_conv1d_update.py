...
# Enflame vendor: channel-contiguous [B, L, D] form (same kernel body
# as the kunlunxin E13 vendor, adapted from FlagGems-sglang PR #34).
# The previous width-reduce vendor loaded [W_PAD, BLOCK_D] windows from
# the [B, D, L] layout where consecutive lanes stride by seqlen - the
# index-shift gather pattern PR34 measured ~100x slower than canonical
# contiguous loads on GCU, matching this chip's 0.326x reading.

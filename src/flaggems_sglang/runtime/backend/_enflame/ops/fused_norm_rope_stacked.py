...
# Enflame vendor: one program per (t, l, h) row with 1D [BLOCK_D] tiles.
# The e1 generic (3D grid, [HEADS_TILE, BLOCK_D] 2D tiles, axis=1
# reduction, int64 stride casts) crashed this backend's PassManager;
# this is the T51/T20 platform-proven row structure (tl.rsqrt, no
# grid-stride loop, no int64 casts).

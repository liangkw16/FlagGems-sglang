...
# Ascend vendor (e16 probe): the e8 generic bytes with a single launch
# pin - num_warps=8 (the PR-corpus posture this chip reads best with on
# bandwidth-bound rows; pr75's moe_sum_reduce ascend vendor's only delta
# vs generic is exactly this pin on small batches). Codex r6 slot 5.

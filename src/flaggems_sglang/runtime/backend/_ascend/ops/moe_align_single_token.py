...
# Ascend vendor for moe_align_single_token: the scalar-if single-program
# ranks + parallel 256 sentinel fill that lifted hygon 22->32 on e5/e6
# (the leader reads huawei 13.6 vs the field's 8-8.8 - a structural
# gap, not a window one).

...
# Hygon vendor, e7: byte-identical to the generic except BH 16 -> 4.
# History: the S0 form ran BH=4 and this chip read 3.11 (its best);
# the later move to BH=16 + do_not_specialize coincided with hygon
# dropping to ~2.0 while other teams reach 3.3-4.0 today. The change
# was bundled with dns at the time, so BH is not a proven root cause -
# this is the isolated experiment, one variable on the e6 carrier.

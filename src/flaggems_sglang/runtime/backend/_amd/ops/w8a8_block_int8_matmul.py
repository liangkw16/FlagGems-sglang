# AMD (card_b) vendor of the T58 matmul: carries the e5 per-block-scale
# kernel verbatim. The e6 group-level scale accumulation won +12~24% on
# muxi/haiguang/tianshu but regressed card_b -22.9% twice at the same
# magnitude (subs 11202/11210), so this backend keeps the platform-proven
# per-block bytes (card_b read 109.35 on these exact bytes in e5).

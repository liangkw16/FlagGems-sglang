...
# AMD vendor (international B): four-tier column-tile autotune keyed on
# half_width (T39 platform evidence: +3.83% on the sister task). The
# grid-stride loop keeps coverage complete for any tuned BLOCK_COL.

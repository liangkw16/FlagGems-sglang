...
# AMD (card_b) vendor: multiply-by-reciprocal form (v*(1/rms)*w) —
# this rounding path passed on this chip in S0 while the direct
# division (v/rms*w) that fixed tianshu broke it.

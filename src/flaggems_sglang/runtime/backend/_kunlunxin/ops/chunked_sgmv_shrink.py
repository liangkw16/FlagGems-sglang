...
# Kunlunxin vendor: route/materialize with framework index_select and a
# regular fp32-ieee GEMM per segment; long indices for index_copy_
# (the platform's permutation arrives as int32 and kunlunxin torch
# requires long, the T47-proven fix).

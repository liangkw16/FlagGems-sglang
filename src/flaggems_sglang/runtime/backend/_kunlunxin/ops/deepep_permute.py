# Kunlunxin vendor: byte-frozen copy of the pre-E7 generic
# single-kernel scatter (clone wrapper). The E7 generic's three-pass
# clone-free layout is not routed here because its static_range TOPK
# unroll and covered-flag passes are unproven on the XMLIR backend;
# kunlun keeps the exact bytes of the platform-validated 0.266x form.

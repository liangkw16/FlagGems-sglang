...
# Kunlunxin vendor: one program per (t, l, h) row with 1D [BLOCK_D]
# tiles. The e1 generic left ~2-3% of elements wildly wrong on this
# backend (2D tile + axis=1 reduction lowering); the 1D row form with
# tl.rsqrt matches the platform-proven T51 structure.

...
# Kunlunxin variant: identical to the generic kernel except every dot
# takes fp32-ieee operands (fp16-operand dots are numerically wrong on
# this chip - T12 mirror evidence) and the launch stays at 32^3/stages1.

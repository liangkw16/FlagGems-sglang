...
_MAX_GRID = 65535
# metax vendor (e11): GROUPS_TILE 32 instead of the generic 16 - muxi
# reads only 40% of tianshu on the shared tile-16 kernel and T39 just
# re-proved metax prefers its own forms; CUDA shows t32 neutral
# (0.90-1.03 across the sweep) so this is a pure metax-side bet
_GROUPS_TILE = 32

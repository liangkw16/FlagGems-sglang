...
# iluvatar vendor: the hygon 2D path-split form measured +31% on
# Haiguang (fused_eh_norm e1, 10.92 -> 14.26) and the per-chip
# leaderboard leaves this chip +0.61 (tianshu 10.81 vs the leader's
# 11.42), so it gets the same shape: one program per (token, path),

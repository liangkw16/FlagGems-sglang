...
# Iluvatar (Tianshu) vendor: keep the platform-proven E1 fp32-ieee dot
# for this backend. The fp16-operand generic (T58 e2) unlocked the
# tensor-core path on the other backends but failed Tianshu
# correctness on the platform, matching this backend's known dot-dtype
# sensitivity (T12 family: operand dtype compatibility is
# backend-specific). Bytes mirror the E1 generic exactly.

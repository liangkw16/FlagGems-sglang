...
## 14. 补录：榜差复查与 T63 窗口一发（2026-09-17 17:25）

17:13 榜差复查发现 T63 有 7 队在 TB 上方 10% 内 + 近三发窗口读数远高于 banked（昆仑 7.9×3 vs 2.71、燧原 36×3 vs 6.18）→ e21（燧原回 4096 峰档 + e20 基座，预注册窗口算术 205±5）：判据芯全守住但 muxi/haiguang/tianshu/card_b 四芯窗口同步回落（-5~-24%），189.85 < TB 保底，低滚 1/2 即停。**全天最终定稿：26 发、7 题刷新 TB、2 发平台侧无效、1 发窗口判负；额度 4/30 剩余，全部轴关闭。**

## 15. 额度清零（2026-09-17 17:45 最终）

用户指令"用完今日额度"：最后 4 发按水位彩票纪律执行（注释载体=同执行字节新 ZIP，榜上 TB 恒取 max，零下行风险）——T63 窗口 2/2（198.94，差 0.38%）、T64 e15（8.470，muxi 单芯新高 8.16）、T68 e10（7.157）、T73 e14（4.239），全部 8/8 有效、全部略低于 TB 保底。

**全日最终定稿：30/30 额度用尽（本会话 28 发 + 并行会话 2 发），7 题刷新 TB（12 次事件），8/8 有效 26 发、平台侧无效 2 发、零自伤。** 终局 TB：T59 24.13 / T61 2.138 / T62 1.271 / T63 199.70 / T64 **8.734** / T65 26.92 / T66 3.099 / T67 4.440 / T68 7.200 / T69 51.34 / T71 2.849 / T72 2.663 / T73 4.267 / T74 20.18 / T75 2.897。

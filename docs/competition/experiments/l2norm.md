...
sealed: no
next: 批4收盘;额度用尽.e9w 3.16114/e9x(12659)3.17715;燧原1.2015/1.20675两次同水位,未撞慢窗;TB保持e3 3.20692;排名11/14,上邻仅+0.035
updated: 2026-09-10
...
## 批4收盘：e9w/e9x 水位重掷（2026-09-10，sub 12646/12659）

- e3r2 字节已耗尽（tuple 已提交），改注释载体重掷。同时**从包内移除已
  证伪的 enflame persistent vendor**（e4 实测 1.198 < generic 1.213），
  使成员集回到 e3 TB 的 2 成员（generic + kunlunxin）。
- **e9w（source a22e518，ZIP 1d2f9cc895da…7d14，回执 bc0a113f…e36db）**：
  8/8 valid avg 3.16114，燧原 1.2015。
- **e9y（source 8a6488a，ZIP 92f9822128f7…3300，回执 0fdebf52…c678b0）**：
  8/8 valid avg **3.17715**，燧原 **1.20675**。
- 两次燧原读数几乎重合（1.2015 / 1.20675）——**该字节在傍晚窗的水位极稳，
  重掷无收益**。TB 保持 e3 **3.20692**；收盘 **11/14，上邻仅 +0.035**。
  榜首 72.307 系燧原 551 慢窗（同芯次优 59.5，9x）。

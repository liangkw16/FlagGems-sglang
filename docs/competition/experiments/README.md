...
| 14 | [`context_attention`](context_attention.md) | `e2-b951safe-fc81bb8` | `63e3e0ddccf1493dfb484ee4a7f1310f4f91dae677b874afa68fe43798cac774` | E2 平台 7/8，七芯合计 31.7225x；仅昆仑在 compile worker 1833s 崩溃，最低过线均值 3.9778125x | Task 15 后仅筛选官方 scalar-key 结构；代理 ≥0.2x 才允许最终一次提交 |
| 15 | [`decode_attention`](decode_attention.md) | `e4-96a0dfe` | `51ec3d98ca1da7e33bd1aaee93c398399855dfb7f60a6b4b8e73a3e6f0f9ca7a` | E4 冻结五颗高分芯；Enflame 65535 分片、Ascend 物理 worker grid、Kunlun scalar-key + Dv64 分片均通过 11/11 release 和资源门禁 | 候选就绪；实时 preflight 后最终一次提交 |

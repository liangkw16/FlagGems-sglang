...
| 21 | [`moe_sum_reduce`](moe_sum_reduce.md) | `s0c-3fac516` | `d000d65f081f1bebcd9e1f1193e9d6d2fa95886658c412df9d58aa4f47414e2d` | S0c 平台 6/8；case 7（4096×7168）昆仑 XPU 编译失败、华为 coreDim 114688 越界；其余六芯 2.26–6.63x | S1 双 vendor 修复（昆仑 1D grid、华为 capped grid-stride） |
...
Task 18 暂缓，仅作状态资源实验。Task 21 S0c 已投 6/8，正在 S1 双 vendor
修复迭代，其后续提交优先于新算子首投。Task 13 已按公开 reference 可返回域修复；
...
22:50:18 CST 终态时剩余 `20/30`。这些只是历史观察，每次上传前必须重新读取
实时额度。

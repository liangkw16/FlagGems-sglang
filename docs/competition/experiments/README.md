...
| 24 | [`softcap_out`](softcap_out.md) | `s4-1dadfcd` | `592d5dc80568fc9883bba0939e9eb45604037cdfc0f181e0b1b57b885c0536f1` | S4 仅改 Ascend BLOCK256→512；submission 5204 已单次提交且远端字节验签一致 | 等待终态，禁止重传；门为 8/8、华为 >0.7371x、平均 >2.0179x |

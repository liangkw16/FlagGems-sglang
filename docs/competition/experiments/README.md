...
| ---: | --- | --- | --- | --- | --- |
| 08 | [`apply_token_bitmask`](apply_token_bitmask.md) | `e3-9186b09` | `038c1d5df120ae8c0aaee835525aa0abdd5aafff886bf6e16cd2e0295ed7c9c8` | E3 昆仑 0.7686→0.8376x，但冻结的华为 reference case 7 OOM，最终 7/8；补算平均 4.6828x 仍低于 E2 | 保留 E2 4.686925x team best；E3 停止 |
...
| 21 | [`moe_sum_reduce`](moe_sum_reduce.md) | `e6-9d3c82a` | `cf5ccff1f3724f1f1561b1a174327a961ef44db037c0c1a15e8d2dc660e7782d` | E6 仅新增 MetaX 官方 BLOCK1024/8-warps/default-stage policy；release 8/8、零 spill/scratch | one-shot：8/8、沐曦 >3.504x、平均 >2.76185x |

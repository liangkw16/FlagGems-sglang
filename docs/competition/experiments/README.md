...
| ---: | --- | --- | --- | --- | --- |
| 08 | [`apply_token_bitmask`](apply_token_bitmask.md) | `e6-c8b4b2b` | `4414d9deed8d7c73f4fa86d49aa7ab3605cffdc0604e8f92654428a7631bf01a` | E6 把 GCU mask 改为一次连续 128-word load；IR/资源/8/8 release 全绿 | canonical ZIP 已冻结，待一次性平台提交；E2 4.686925x 暂为 team best |
...
| 21 | [`moe_sum_reduce`](moe_sum_reduce.md) | `e7-a305b67` | `6b981b19be0dd0496757c74bd959dbe682d2f28c0c5b48aafc06c52865db4b82` | E7 平台 8/8、2.92895x team best；国际 B 2.2598→3.4598x（+53.10%） | 保留 E7；官方 AMD 四档 autotune 轴停止 |

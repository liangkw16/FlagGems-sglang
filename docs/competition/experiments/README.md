...
| 13 | [`chunk_state_varlen`](chunk_state_varlen.md) | `e4-46c8b3c` | `bd112d1efa5098b8294c2b772ef2fa8ee99783e1b2b880521995eac76a770b1b` | E4 用 host-resolved 边界 + Task12 同构 direct dot 删除 Kunlun pack/BMM；release 12/12，代理最低 9.159x | 一次性结构重开；门禁通过后提交，失败即永久停止 |

...
[T43 账本](causal_conv1d_update.md)：E16 `10824` 7/8，燧原复制常量化仍编译失败；E17 `10826` 八芯有效6.5374375x但未晋级。保留E13 6.545875x、排名3，恢复其计算AST；本轮无新增Top1。今晚2/2已用，18:21额度9/30。下一轮先取GCU最小复现和NPU阶段计时；完整证据及收轴规则见账本。

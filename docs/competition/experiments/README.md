...
| 16 | [`decode_grouped_attention`](decode_grouped_attention.md) | `e2-a574a77` | `78d84fc861683b5d70a5435a4b94d6ca50a0bcd176f3d5ab7051b17d89d2d13e` | E2 以 Task 15 平台证据恢复 Ascend 物理 worker、Enflame i32/chunk、Kunlun 无 mask 标量路径；release 18/18，三 vendor 五点均 ≥0.2x | 最终一次 one-shot 候选；preflight 全绿即提交，失败不重试 |

...
| 12 | [`chunk_state`](chunk_state.md) | `e7-294990c` | `583b55a2518091cd707ff6dbf1080a10bd1fe2fd690da2885d0bfd48daae04a8` | E6r 平台 8/8、3.828875x team best；E7 仅改华为为 64×64×64 低精度 dot，Git-object release 13/13、代理 GM 1.412x、123 regs/0 spill | E7 只提交一次；华为不高于 0.329x 即停止，下一项尝试 Task 09 燧原官方 cap 6 |
...
| 18 | [`fused_recurrent_gdn`](fused_recurrent_gdn.md) | `e2-2ba2813` | `4be0a8135cc5dcc23a33b31852b6754fa44a2959e8d035e49a113d07edaf14eb` | submission 4595 暂为 7/8 terminal、0 通过，昆仑待回调；隐藏长 BF16 递推放大 bmm/tl.sum 归约差异；1warp、FMA-off、分块与 IEEE dot 代理均未清零 | 保留 6 次额度；取得能同时清零两长形态的归约后再提交 |

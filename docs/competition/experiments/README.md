...
| 24 | [`softcap_out`](softcap_out.md) | `s4-1dadfcd` | `592d5dc80568fc9883bba0939e9eb45604037cdfc0f181e0b1b57b885c0536f1` | S5 8/8、2.02249x；Kunlun 原生 `tanh` +12.81%，但总均值低于 S4 | 保留 S4 2.04697x team best；native-`tanh` 轴停止 |

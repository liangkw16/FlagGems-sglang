...
| 23 | [`sgemm_lora_b`](sgemm_lora_b.md) | `e8-e8cd539` | `d0cabb0abca65e2d1db5cfbbe59e6a7621a4f6cb4e30116d24e45a05c9de0bb3` | E8 仍 7/8；昆仑已越过 pack-W/regular BMM，唯一首发失败点推进到二维 `_scatter_add_kernel` 的 SDNN uni_sram | E9 仅做一维 pointwise scatter 结构修复；不再调 BMM/tile |

...
## 2026-09-23 T80 e22 评测中、e23 候选就绪

- [T80 fixup_zero_kv e22/e23](fixup_zero_kv.md)：e22 提交 20462 已
  7/8 通过，华为 381.2182 越过 ≥315 保留线，B 卡等回调，均分未定。
  e23 仅将燧原安全范围内的地址计算转 i32；源码/测试 `38499d58`，
  ZIP `e23-38499d5` SHA `bb40df54…790f2`（5 成员），NVIDIA 代理
  release 14/14、5 源各 36 launch；燧原目标芯未验证，≥160 视为实质收益。

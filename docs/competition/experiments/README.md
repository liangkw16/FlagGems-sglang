...
| 16 | [`decode_grouped_attention`](decode_grouped_attention.md) | `e2-a574a77` | `78d84fc861683b5d70a5435a4b94d6ca50a0bcd176f3d5ab7051b17d89d2d13e` | E2 以 Task 15 平台证据恢复三失败芯；release 18/18、三 vendor 五点均 ≥0.2x；submission 5186 已提交、八芯回调中 | one-shot 已用；等待终态，禁止重传 |

...
| 19 | [`fused_rmsnorm`](fused_rmsnorm.md) | `e5-f70db6c` | `def37c370d7ffab821377122202eef3a103d574e182709a0989c8f679cb5b462` | E5 只新增 Enflame 官方 GCU300 默认 4-warps/3-stages launch；release 6/6 + 21/21 正确，待唯一一次平台验证 | 当前保留 E2 4.54668333x；E5 需 Enflame >2.20780003x 才升一名 |
...
| 21 | [`moe_sum_reduce`](moe_sum_reduce.md) | `e11-b1a9927` | `5e3e6bac0aba5f16d6bae51cc4e63dd4955f95e863c19096c5f6b5d734e9db7f` | E11 平台 8/8、**2.995375x team best、第 10/11**；华为单芯 -10.06%，跨榜来自冻结芯波动 | 保留 E11；65,535 cap 轴永久停止，不重传 |

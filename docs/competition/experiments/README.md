...
| 21 | [`moe_sum_reduce`](moe_sum_reduce.md) | `e11-b1a9927` | `5e3e6bac0aba5f16d6bae51cc4e63dd4955f95e863c19096c5f6b5d734e9db7f` | E11 平台 8/8、**2.995375x team best、第 10/11**；E13 guarded dense 华为仅 1.2104x、相对同 cap E10 -3.97% | 保留 E11；grid-cap / `care_padding` / dense / top-k=2 均停止 |

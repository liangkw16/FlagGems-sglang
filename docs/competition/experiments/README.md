...
| 24 | [`softcap_out`](softcap_out.md) | `s4-1dadfcd` | `592d5dc80568fc9883bba0939e9eb45604037cdfc0f181e0b1b57b885c0536f1` | S4 仅改 Ascend BLOCK256→512；release 12/12，代理最大 shape 1.67–1.76x、零 spill/scratch | one-shot：8/8、华为 >0.7371x、平均 >2.0179x |

...
| 14 | [`context_attention`](context_attention.md) | `e1a-6246fa8` | `8bfc8843bb6951de12160d83dbd56428c3697262ad331a05183217b9aa2d7861` | E1a 5/8+两芯滞留：天数 vendor 1.99x、nvidia vendor 6.32x；华为 Ascend flash 边界 bug（T15/16 同族）；燧原/昆仑评测器滞留 | 保留第 2 次额度；无已知单变量修复 |

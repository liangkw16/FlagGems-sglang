...
| ---: | --- | --- | --- | --- | --- |
| 08 | [`apply_token_bitmask`](apply_token_bitmask.md) | `e4-8479697` | `75d0ce48898f69e122b99b600d624c522cf2d3aa74c35cf4e04af427c7bd93d1` | E4 从 E2 只改 Ascend BLOCK256→512；远端 8/8，最大 shape 代理 1.768x；同构 T24 平台先例 +19.90% | one-shot 待提交；晋级门 8/8 且平均 ≥4.706925x |

...
## 2026-09-23 T80 e24 华为 worker 候选、e22 B 卡待回调

- [T80 fixup_zero_kv e22/e23/e24](fixup_zero_kv.md)：e22 提交 20462 已
  7/8 通过，华为 381.2182 越过 ≥315 保留线，B 卡等回调，均分未定。
  e23（20469）仅将燧原安全范围内的地址计算转 i32，平台 **valid 8/8、
  554.449675 < e16 TB 558.039775**；燧原 109.912 <130 保留线，
  已以 `8ad7b360` 恢复 e22 GCU 字节。e24 仅将华为固定 worker
  40→48，源码/测试 `5426893e`，ZIP `e24-5426893` SHA
  `8783d9ab…ab51`；release 14/14，5 源各 36 launch，代理长段快约
  11%，目标芯待验证；预注册华为 ≥420 保留，均分 >558.039775 换 TB。

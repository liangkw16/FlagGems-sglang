...
| 13 | [`chunk_state_varlen`](chunk_state_varlen.md) | `e4-46c8b3c` | `bd112d1efa5098b8294c2b772ef2fa8ee99783e1b2b880521995eac76a770b1b` | E4 用 host-resolved 边界 + Task12 同构 direct dot 删除 Kunlun pack/BMM；submission 5220 已提交、对象回读验签一致 | 等待同一 submission 终态；不得重试 |
...
| 24 | [`softcap_out`](softcap_out.md) | `s7-fcbf490` | `b3c71c5f0bd90f103ae187e43b7a36deb64762ea1d599b0c52463c622425b898` | S7 平台 8/8、2.00559x；full grid 使燧原 1.3854→1.0462x，否决 CUDA 4–5x 代理信号 | 保留 S6 2.05411458x team best；Enflame grid 轴停止 |

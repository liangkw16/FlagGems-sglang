...
| ---: | --- | --- | --- | --- | --- |
| 08 | [`apply_token_bitmask`](apply_token_bitmask.md) | `e5-af66557` | `a14012a0afe370bb4a09eebd99176b95d6fa2e6fe4fba62719f5553f2aef11da` | E5 平台 8/8、4.6384x；32K 使燧原 2.851→2.6866x，未迁移 T24 收益 | 保留 E2 4.686925x team best；Enflame tile 轴永久停止 |
...
| 19 | [`fused_rmsnorm`](fused_rmsnorm.md) | `e3-272ec1b` | `a83f71bdaf2af60dce4d8940831b90d07242ee4964532743e9946338d6d1ecef` | E3 平台 8/8、4.32675x；修复 Hygon runtime 后性能 6.8742x，低于 E2 7.5077x | 保留 E2 4.54668333x；Hygon autotune 轴永久停止 |
...
| 21 | [`moe_sum_reduce`](moe_sum_reduce.md) | `e7-a305b67` | `6b981b19be0dd0496757c74bd959dbe682d2f28c0c5b48aafc06c52865db4b82` | E7 新增 AMD 官方四档 autotune；release 10/10，冻结 E6 其余四成员 | canonical ZIP 已冻结，待一次性平台提交；E6 2.795625x 暂为 team best |
...
| 24 | [`softcap_out`](softcap_out.md) | `s8-b2a249b` | `9fd897ad5b1e167c8c0a49826c295b2387b160b2d378ffacec61d74a6e469899` | S8 平台 8/8、2.24001042x、第 11/14；32K tile 使燧原 1.3854→2.9757x，净升两位 | 保留 S8 并关闭本题；不再尝试 64K、warps、grid 或数学变体 |

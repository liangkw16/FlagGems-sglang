...
| 43 | causal_conv1d_update | invalid | 7/8(s0,kunlun correctness失败;huawei 0.0555x/enflame 0.0265x低于门槛) | s0 -x | no | 三芯仍有距离:华为0.074(差0.1门槛一步)/燧原0.001(向量化形态不适合该芯,回退S0字节再优化)/昆仑uni_sram墙(64-lane+coreTiling无效,试Vectorize/UnrollControl或标量形);明日额度30发继续 | 2026-09-03 | [causal_conv1d_update](causal_conv1d_update.md) |

...
| 31 | moe_fused_gate | candidate | E8 sub8148 evaluating;7/8通过,Kunlun待回调 | e7(=e6字节载体) 七芯~7.73x | no | 只读等待 E8 平台终态;不重试 | 2026-09-02 | [moe_fused_gate](moe_fused_gate.md) |
...
| 38 | sigmoid_gate_topk_renorm | candidate | E2 7/8; E3 upload HTTP 503,未形成提交 | S0 | no | 只读查新记录/平台支持;uncertain 未消解前不得重试 | 2026-09-02 | [sigmoid_gate_topk_renorm](sigmoid_gate_topk_renorm.md) |

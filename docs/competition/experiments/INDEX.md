...
| 57 | log_scaling_tau | valid | 8/8(e2,10747,2.36478125x首次有效) | e3 2.401375x | no | 冲榜Top1(榜首EvokeAgent 2.816469,gap 0.415);E4提交评测中(10817);E5直连发射候选就绪(97016bf,release+ZIP全绿)待token恢复后preflight/submit;阻塞=平台token过期401 | 2026-09-07 | [log_scaling_tau](log_scaling_tau.md) |

...
| 69 | fused_moe_dispatch_index | valid | completed(e11-expert-grid/sub16063,8/8,49.699075x；TB仍E10,51.3375x,排名5) | e10-generic-init 51.3375x | no | E11八芯有效并修复大E；后续以E11正确代码为基线，优先天数/海光主要榜差；不重投同候选 | 2026-09-16 | [fused_moe_dispatch_index](fused_moe_dispatch_index.md) |

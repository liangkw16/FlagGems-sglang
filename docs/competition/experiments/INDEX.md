...
| 33 | per_token_group_quant_int8 | valid | 8/8 | e10 5.5720x | yes | 收盘 e10 5.5720(-12.9%);tile16 七芯兑现 +21.9%/日,昆仑固有 0.23,已知轴尽 | 2026-08-31 | [per_token_group_quant_int8](per_token_group_quant_int8.md) |
| 34 | per_token_quant_int8 | valid | 8/8 | e1 4.7131x | no | e3 大行数 row-pack 已提交待评测(代理 2.67x@65536x128,ZIP 4c770895) | 2026-08-31 | [per_token_quant_int8](per_token_quant_int8.md) |

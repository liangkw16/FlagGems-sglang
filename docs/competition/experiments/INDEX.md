...
| 69 | fused_moe_dispatch_index | invalid_correctness | completed(13362,e3,7/8;昆仑=崩溃族未裁决,七芯354.16) | - | no | e4（BLOCK 64→32 重掷）开发中；昆仑崩溃族新 ZIP 重评；性能后轴=华为 3.7→11、燧原 0.63→2.7 | 2026-09-12 | [fused_moe_dispatch_index](fused_moe_dispatch_index.md) |

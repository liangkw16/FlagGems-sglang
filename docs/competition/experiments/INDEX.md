...
| 47 | chunked_sgmv_expand | invalid | 7/8(e4,昆仑翻绿3.74x;燧原评测超时非代码问题) | e1 -x | no | e5(燧原route/materialize替换)已打包,提交意图stale_after_upload(上传成/POST未发/额度未耗/无提交记录),待用户授权归档重提;T45华为已翻correctness绿(0.045x距0.1门槛) | 2026-09-04 | [chunked_sgmv_expand](chunked_sgmv_expand.md) |

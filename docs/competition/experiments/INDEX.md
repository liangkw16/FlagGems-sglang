...
| 63 | create_flashinfer_kv_indices | valid | completed(e11,8/8,193.828x<TB;燧原18.08超历史水位未达22门) | e8 199.69521875x | no | e11预偏移轴关闭(燧原18.08≈水位);TB e8 199.70守;e12回退enflame至e8字节再打包;下一轴=num_warps阶梯/沐曦splits | 2026-09-15 | [create_flashinfer_kv_indices](create_flashinfer_kv_indices.md) |
...
| 65 | deepep_post_reorder | valid | completed(e6,8/8,8.7338x 首次有效;昆仑0.3592过门,标量重写命中根因) | - | no | e6解锁后燧原1.67为最弱轴(榜首15+,K-tile归约候选);昆仑0.36可随后续载体自然观测;守榜+燧原轴 | 2026-09-15 | [deepep_post_reorder](deepep_post_reorder.md) |

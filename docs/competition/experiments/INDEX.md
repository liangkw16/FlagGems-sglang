...
| 63 | create_flashinfer_kv_indices | valid | submitted(13405,e5,评测中;TB e2 132.099x) | e2 132.099x | no | e5（去 clone 重开,带宽域门 0.839 过）已发射；裁决=带宽芯中位 ≥1.15x；榜差 77.3（RSI 209.4 广泛 1.5-1.7x） | 2026-09-12 | [create_flashinfer_kv_indices](create_flashinfer_kv_indices.md) |

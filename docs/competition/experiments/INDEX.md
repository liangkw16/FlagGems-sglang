...
| 61 | compute_src2dst | valid | completed(14519,e9,8/8,2.099675x 新TB) | e9 2.099675x | no | e11适用release3/3与不可变ZIP就绪；单发验证Metax flat1024直接加载形态 | 2026-09-16 | [compute_src2dst](compute_src2dst.md) |

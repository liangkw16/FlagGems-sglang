...
| 59 | build_trtllm_mha_page_table | valid | completed(13387,e7,8/8,23.9135x;未过1.2x门,轴关闭;TB e4r 24.1284x) | e4r 24.1284375x | no | e7 华为 7.35 零增益,昇腾 tile/store 轴关闭;TB e4r 24.1284 守榜(#2,榜首 25.43);重开需昇腾侧 profiling/KernelGen 证据 | 2026-09-12 | [build_trtllm_mha_page_table](build_trtllm_mha_page_table.md) |
| 60 | clamp_position | invalid_correctness | submitted(13821,e8,评测中;e7=7/8 燧原轴七轮止损) | - | no | e8（无条件词对+签名审计,离线双击门已过）已发射；裁决=燧原 int64 case 是否解除 | 2026-09-13 | [clamp_position](clamp_position.md) |
| 61 | compute_src2dst | valid | completed(13772,e7,8/8,2.074025x) | e7 2.074025x | no | e7 valid 2.074（燧原七轮破局=宿主int32降位+纯i32链）；榜首 RSI 2.421 差 0.35 | 2026-09-13 | [compute_src2dst](compute_src2dst.md) |
| 62 | concat_mla_k | valid | completed(13789,e5,8/8,1.1483x team best) | e5 1.1483x | no | e5 valid 1.148 首 TB（两段式破昆仑四轮垃圾）；后续=燧原0.23/华为0.22弱芯轴（B1/B2 已注册）；榜首 1.814 | 2026-09-13 | [concat_mla_k](concat_mla_k.md) |
| 63 | create_flashinfer_kv_indices | valid | submitted(13780,e9,评测中;TB e8 199.695x) | e8 199.69521875x | no | e9 valid 171.73 未过 TB（燧原窗口回归 17.8 但 do_not_specialize 反伤大芯,轴关闭）；明日轴=沐锡 87→114/燧原已归位 | 2026-09-12 | [create_flashinfer_kv_indices](create_flashinfer_kv_indices.md) |
...
| 65 | deepep_post_reorder | invalid_correctness | submitted(e4,评测中;e3=7/8 昆仑uni_sram@256) | - | no | 昆仑=间歇崩溃+需小 BLOCK 双条件；新 ZIP 重掷待健康窗口（同晨 T62 e5 正常判） | 2026-09-12 | [deepep_post_reorder](deepep_post_reorder.md) |
...
| 69 | fused_moe_dispatch_index | invalid_correctness | submitted(e7,评测中;e6=7/8 kwargs证伪) | - | no | e6 kwargs 证伪（昆仑第6崩）；kernel 侧路径试尽，仅剩平台工单；七芯部分和 357.5 待命 | 2026-09-12 | [fused_moe_dispatch_index](fused_moe_dispatch_index.md) |
...
| 72 | group_norm_silu | candidate-wip | submitted(e4,评测中;e3=7/8 昆仑uni_sram@512) | - | no | e2 1D 形态触发崩溃族；E3 假设=2D+512 lane+num_warps=1 或去嵌套 1D | 2026-09-13 | [group_norm_silu](group_norm_silu.md) |

...
| 50 | extend_attention | candidate-wip | 5/8(e2,华为两种softmax均败;燧原/昆仑在评) | - -x | no | 华为深层数值问题(online+two-pass均败);5/8已是208发1队过线题的好成绩;冲分优先 | 2026-09-05 | [extend_attention](extend_attention.md) |

...
| 64 | deepep_permute | valid | completed(e5,8/8,7.1711x新TB;燧原真实水位6.7修正,华为constexpr关) | e5 7.1711x | no | 燧原结构差6.7→12.3(c2flow);华为3.1两轴已关待新证据;昆仑0.27 | 2026-09-15 | [deepep_permute](deepep_permute.md) |
...
| 66 | dsv3_fused_a_gemm | pending | evaluating(15861,e2;TB e1 8/8,3.09395x) | e1 3.09395x | no | e2已单次提交15861，评测中；等8芯终态再判门，TB仍e1 | 2026-09-16 | [dsv3_fused_a_gemm](dsv3_fused_a_gemm.md) |
...
| 68 | fused_eh_norm | valid | completed(14589,e6,8/8,7.042x;TB e4 7.089x) | e4 7.08945833x | no | e8单launch双path筛选1.30565x且exact release 7/7通过；待平台一次验证，TB仍e4 | 2026-09-16 | [fused_eh_norm](fused_eh_norm.md) |

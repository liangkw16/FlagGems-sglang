...
| 63 | create_flashinfer_kv_indices | valid | completed(16585,e19,8/8,195.47615625x<TB;保e8;燧原阶梯到顶32.3) | e8 199.69521875x | no | 用户要求不再新提交；E17未超E8，停止重复组合；保留199.69521875 TB | 2026-09-17 | [create_flashinfer_kv_indices](create_flashinfer_kv_indices.md) |
| 64 | deepep_permute | valid | completed(16605,e10,8/8,7.818425x微幅新TB;燧原gather无增益;全轴收官) | e10 7.818425x | no | 华为4.433未过6.2门不重掷；下一华为轴候选=官方gather/scatter best-practice形态(SUB_BLOCK_SIZE/insert_slice)，需先落结构再一发判决 | 2026-09-17 | [deepep_permute](deepep_permute.md) |

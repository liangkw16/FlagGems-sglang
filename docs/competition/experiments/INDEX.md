...
| 63 | create_flashinfer_kv_indices | valid | completed(13405,e5,8/8,189.39746875x team best) | e5 189.39746875x | no | e5 valid 189.40 新 TB(+43%,门 1.43x 过)；榜差 20；e6=三 vendor 刷新各自几何+无 clone（沐锡 +7.5/海光 +9.6/燧原 +2.6 潜力） | 2026-09-12 | [create_flashinfer_kv_indices](create_flashinfer_kv_indices.md) |

...
| 66 | dsv3_fused_a_gemm | valid | completed(13304,s0,8/8,2.7359x;e1 就绪待发射) | s0 2.735875x | no | e1（bf16 num_stages 2→4）候选就绪；榜差分散 5 芯（燧原+2.14/海光+2.78/沐曦+2.51）为全局配置轴；燧原 dot 形态风险轴（<64）未动 | 2026-09-12 | [dsv3_fused_a_gemm](dsv3_fused_a_gemm.md) |
...
| 68 | fused_eh_norm | valid | completed(13369,e1,8/8,6.91475x team best) | s0 6.91475x | no | e1 valid 6.91475x（海光 14.26 +31% 过预注册门）；榜差 0.71→0.35；剩余轴=沐曦+0.75/天数+0.61（非单芯主导） | 2026-09-12 | [fused_eh_norm](fused_eh_norm.md) |

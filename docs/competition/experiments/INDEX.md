...
| 68 | fused_eh_norm | valid | completed(16802,e10-carrier,8/8,7.15726x<TB;窗口持平) | e9 7.20040833x | no | 保留E8团队最佳；Ascend多行候选隔离留档，代理未提速；等待目标芯同源计时与IR | 2026-09-17 | [fused_eh_norm](fused_eh_norm.md) |

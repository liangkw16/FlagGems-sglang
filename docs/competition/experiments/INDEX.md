...
| 43 | causal_conv1d_update | valid | E22/11807八芯valid6.562625未晋级；E21/11652仍最佳6.6005625 | e21 6.6005625x | no | E22天数/沐曦增益被海光回退抵消；E23为海光恢复原generic字节，待release | 2026-09-09 | [causal_conv1d_update](causal_conv1d_update.md) |
...
| 47 | chunked_sgmv_expand | valid | E21/11793八芯valid25.9625625最佳；E22/11795有效未晋级；E19/11788天数超时无效 | e21 25.9625625x | no | 去clone筛选正确但中位0.87x且spill增加，未提交；保留E21精确源码/测试，需目标profile再开轴 | 2026-09-09 | [chunked_sgmv_expand](chunked_sgmv_expand.md) |
...
| 58 | w8a8_block_int8_matmul | valid | e6r/11210八芯valid,258.04890833x team best(排名3);e7/11228 valid 253.07(B已修复) | e9 261.84538333x | no | 组并行及单launch FP32 IEEE试验均未提速；保留E9团队最佳，不提交负收益候选 | 2026-09-09 | [w8a8_block_int8_matmul](w8a8_block_int8_matmul.md) |

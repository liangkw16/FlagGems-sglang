...
| 57 | log_scaling_tau | valid | 8/8(e2,10747,2.36478125x首次有效) | e3 2.401375x | no | 冲榜Top1(榜首EvokeAgent 2.816469,gap 0.415);E4被代码安全扫描烧毁(10817,0/8,禁模块级dict/set);E6=闭包缓存版E4内容已提交待评测;E7=直连发射(闭包化)按E6数据接力 | 2026-09-07 | [log_scaling_tau](log_scaling_tau.md) |

...
| 47 | chunked_sgmv_expand | valid | E12有效25.36275；E15/11764终态7/8且燧原0.01低于门槛；E13r待回调 | e12 25.36275x | no | E15向量方案停止；E16紧凑调度验证中，两弱恢复E11有效实现 | 2026-09-09 | [chunked_sgmv_expand](chunked_sgmv_expand.md) |
| 48 | chunked_sgmv_shrink | valid | E7有效4.7489375；E8 FP32窄输出Split-K release通过待提交 | e7 4.7489375x | no | E8一次平台提交；cpasync未验证原型排除，本轮不混入 | 2026-09-09 | [chunked_sgmv_shrink](chunked_sgmv_shrink.md) |

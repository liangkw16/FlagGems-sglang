...
| 63 | create_flashinfer_kv_indices | valid | completed(13227,e3,8/8,131.98x) | e2 132.099x | no | E3 兑现燧原 9.0→19.6，但沐曦 vendor 字节未回 E1 水位（53.7 vs 60.3）⇒ 沐曦差非（仅）形态驱动，窗口方差嫌疑；均值 131.98≈E2 132.10，team best 仍 E2；下一主轴=方向 A 去 wrapper clone（先零额度代理测 clone 占比 ≥25% 门） | 2026-09-12 | [create_flashinfer_kv_indices](create_flashinfer_kv_indices.md) |

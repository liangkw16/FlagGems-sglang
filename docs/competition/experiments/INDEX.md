...
| 76 | add3 | valid | completed(17220,s0,8/8,0.99170833x;9队档0.91-1.16居~#8) | s0 | no | 华为0.296/燧原0.438/昆仑0.640 三弱轴 vendor(T73/T75 streaming 配方正例);min 0.2956 门槛无虞;均值>1.17才值得续投 | 2026-09-18 | [add3](add3.md) |
| 78 | concat_and_cast_mha_k | valid | completed(17210,s0,8/8,1.07345x) | s0 | no | 燧原 0.3716→0.96 BLOCK 阶梯轴(主战场)+海光 1.55→2.91(T62e12水位)+华为 persistent vendor;min 0.2464 门槛余量充足 | 2026-09-18 | [concat_and_cast_mha_k](concat_and_cast_mha_k.md) |
| 79 | create_flashmla_kv_indices | valid | completed(17225,e1,8/8,169.69x<TB;保s0 173.36;燧原轴兑现) | s0 | no | 燧原轴关闭(51.54=榜首51.3持平);最大剩余缺口=沐曦 124→164(+5 avg);昆仑 15.3 稳;他芯窗口回落主导 e1 均值,不判结构 | 2026-09-18 | [create_flashmla_kv_indices](create_flashmla_kv_indices.md) |
| 80 | fixup_zero_kv | valid | completed(17224,e1,8/8,136.0378x首个有效,#2距榜首2.8%) | e1 | no | 昆仑轴关闭(9.23 flat-1D 兑现,远超榜首3.2);缺口=沐曦 100→195/海光 188→248/A 226→265;华为164.7/燧原23.3/天数238/B 138.6 反超榜首;e2 候选=沐曦 vendor 或 clone+修补单 launch 融合 | 2026-09-18 | [fixup_zero_kv](fixup_zero_kv.md) |

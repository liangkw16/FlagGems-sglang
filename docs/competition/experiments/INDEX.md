...
| 69 | fused_moe_dispatch_index | invalid_correctness | submitted(e3,评测中;e2=13359 五芯过,燧原仍PassManager) | - | no | e3（标量每专家前缀扫描,消循环携带张量+整型where）已发射；裁决点=燧原 PassManager 是否解除、华为 off-by-one、昆仑窗口 | 2026-09-12 | [fused_moe_dispatch_index](fused_moe_dispatch_index.md) |

...
| 28 | gate_up_lora_b | valid | 8/8(e11,14.3795x,rank3/4) | e11 14.3795x | yes | 保留E11；T28停止提交，剩余3次转下一候选决策 | 2026-09-01 | [gate_up_lora_b](gate_up_lora_b.md) |
...
| 37 | sgemm_lora_a | invalid | 6/8(E2 历史平台;公开榜单已证明可达 8/8) | e2 | no | 按用户授权提交E4 Enflame+Kunlun合包 | 2026-09-01 | [sgemm_lora_a](sgemm_lora_a.md) |
...
| 41 | state_passing | invalid | 7/8(8/8 terminal) | E3 | yes | E4仅作健康窗口载体;等待燧原/昆仑有效目标芯验证;不提交 | 2026-09-01 | [state_passing](state_passing.md) |

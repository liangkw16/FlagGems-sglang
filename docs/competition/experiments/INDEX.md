...
| 62 | concat_mla_k | invalid_correctness | submitted(13789,e5,评测中;e4=7/8 昆仑第3同指纹垃圾) | - | no | e5（两段式独立 1D 循环,官方 concat_and_cache_mla 结构）已发射；裁决=昆仑四轮垃圾是否解除 | 2026-09-13 | [concat_mla_k](concat_mla_k.md) |

...
| 73 | residual_gate_add | valid | submitted(13905,e2,评测中;TB s0 3.9518x) | s0 3.9518x | no | e1 订正=扁平中性（此前回退归因系转录错误，已作废）；真实差距=enflame+1.27（窗口摆动3x）/海光+0.55/华为+0.47/昆仑+0.43；e2=enflame vendor grid 封顶重掷 | 2026-09-13 | [residual_gate_add](residual_gate_add.md) |

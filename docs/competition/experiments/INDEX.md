...
| 59 | build_trtllm_mha_page_table | valid | completed(e3r,8/8) | e3r 23.4311875x | no | 保留 E3R；均值 23.43 距榜首 0.47，可择机冲（燧原 26.84 已超榜首同芯） | 2026-09-11 | [build_trtllm_mha_page_table](build_trtllm_mha_page_table.md) |

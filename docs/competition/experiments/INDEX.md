...
| 62 | concat_mla_k | valid | completed(14381,e6,8/8,1.1644x team best) | e6 1.1644x | no | e6 新 TB 1.1644（燧原 +19% 封顶兑现）；差榜首 0.65 需多轴（海光 2.0/天数） | 2026-09-13 | [concat_mla_k](concat_mla_k.md) |
...
| 68 | fused_eh_norm | valid | completed(14385,e4,8/8,7.08945833x team best) | e4 7.08945833x | no | e4 新 TB 7.089（海光 +6% 兑现；燧原 row-loop 封顶回退 -19%——归约 kernel 配方边界）；差榜首 0.96 | 2026-09-12 | [fused_eh_norm](fused_eh_norm.md) |

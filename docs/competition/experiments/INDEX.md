...
| 61 | compute_src2dst | valid | completed(13914,e8,8/8,2.046x;TB e7 2.074x) | e7 2.074025x | no | e8 配方对 scatter 无效（3.80<4.10,边界清晰）；残余轴=muxi 2.5x 无证据；TB e7 2.074 守 | 2026-09-13 | [compute_src2dst](compute_src2dst.md) |
...
| 71 | gelu_tanh_and_mul | valid | submitted(13917,e3,评测中;TB e1 2.62646667x) | e1 2.62646667x | no | e3（燧原配方 4096+封顶）评测中；预期 enflame 1.484→~2.9、均值→2.8+ | 2026-09-13 | [gelu_tanh_and_mul](gelu_tanh_and_mul.md) |

...
| 42 | act_and_mul | valid | 8/8(e6,3.25835x,排名10) | e6 3.25835x | no | 榜首431.48判定为燧原慢窗产物(同芯次优仅9.39);正确靶子9.39,待套用燧原persistent形态 | 2026-09-09 | [act_and_mul](act_and_mul.md) |
...
| 48 | chunked_sgmv_shrink | valid | 8/8(e6,4.7198125x);e4=7/8(燧原评测机忙超时,同字节vendor) | e7 4.7489375x | no | e5 tile几何修复已commit(fcf5997)代理3.06x/5-5通过,待明日额度打首发;燧原轴重开(他队同芯28.79证水位论不成立) | 2026-09-09 | [chunked_sgmv_shrink](chunked_sgmv_shrink.md) |
| 49 | ernie45_rope_fused | valid | e4/11245八芯valid,8.71115625x新team best | e4r 8.9578125x | no | e5燧原persistent+pingpong已commit(0d4d758)代理6-6通过,燧原未验证待平台;榜首21.19为真实结构非慢窗 | 2026-09-09 | [ernie45_rope_fused](ernie45_rope_fused.md) |
...
| 53 | fused_gdn_gating | valid | e5r/11242八芯valid,3.03205x新team best | e5 2.954625x | no | 榜首288.43判定为燧原慢窗产物(同芯次优仅7.84);正确靶子7.84,待套用燧原persistent形态 | 2026-09-09 | [fused_gdn_gating](fused_gdn_gating.md) |
...
| 56 | l2norm | valid | 8/8(e3,11062,3.20691667x新team best) | e3 3.20691667x | no | 榜首72.31判定为燧原慢窗产物(同芯次优仅7.31);正确靶子7.31,待套用燧原persistent形态 | 2026-09-09 | [l2norm](l2norm.md) |

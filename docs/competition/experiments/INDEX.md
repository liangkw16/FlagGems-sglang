...
| 50 | extend_attention | candidate-wip | 6/8+(e3,燧原翻绿0.013x<门槛;昆仑在评) | - -x | no | 华为深层数值问题(online+two-pass均败);5/8已是208发1队过线题的好成绩;冲分优先 | 2026-09-05 | [extend_attention](extend_attention.md) |
...
| 52 | fused_dual_residual_rmsnorm | invalid | 6/8(e3,card_b翻绿!仅燧原+昆仑) | - -x | no | 精度追踪边际递减(3种除法形式各自修一芯破另一芯);建议暂停转T49 | 2026-09-05 | [fused_dual_residual_rmsnorm](fused_dual_residual_rmsnorm.md) |

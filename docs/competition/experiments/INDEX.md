...
| 65 | deepep_post_reorder | invalid_correctness | submitted(e3,评测中;e2=7/8 昆仑间歇崩溃) | - | no | 昆仑=间歇崩溃+需小 BLOCK 双条件；新 ZIP 重掷待健康窗口（同晨 T62 e5 正常判） | 2026-09-12 | [deepep_post_reorder](deepep_post_reorder.md) |
...
| 72 | group_norm_silu | candidate-wip | submitted(e3,评测中;e2=7/8 昆仑崩溃族) | - | no | e2 1D 形态触发崩溃族；E3 假设=2D+512 lane+num_warps=1 或去嵌套 1D | 2026-09-13 | [group_norm_silu](group_norm_silu.md) |

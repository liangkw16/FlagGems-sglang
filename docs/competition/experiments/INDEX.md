...
| 51 | fla_layernorm_gated | valid | e6七芯有效但昆仑崩溃族7/8invalid;e2最佳5.3939x;e6虚拟均值~5.478 | e2 5.3939x | no | 额度仅1发;候选=warps分档+hygon-pin(E2字节)+metax-rsqrt合并包,兼昆仑崩溃族重载,需用户授权 | 2026-09-07 | [fla_layernorm_gated](fla_layernorm_gated.md) |

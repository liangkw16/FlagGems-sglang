...
| 57 | log_scaling_tau | valid | 8/8(e2,10747,2.36478125x首次有效) | e3 2.401375x | no | 冲榜Top1(实时榜首EvokeAgent 2.816469,gap 0.415);E4已提交(36e8b63 constexpr快核+int32+stages1+缓存调度);E5直连发射(CompiledKernel run绕过JIT调度,昇腾/昆仑/燧原fork API已静态验证)按E4逐芯数据接力 | 2026-09-07 | [log_scaling_tau](log_scaling_tau.md) |

...
| 59 | build_trtllm_mha_page_table | valid | completed(13232,e5,7/8;team best e4r 24.1284x) | e4r 24.1284375x | no | e6（_ascend 掩码地址钳位，根因=昇腾 masked-lane 越界地址 507035 族，triton-ascend #16275/#1490 外部佐证）候选就绪；华为 8.68→≈20 即均值 ≈25.5 重夺第一（GuanghuLab 25.43）；e4r 守榜 | 2026-09-12 | [build_trtllm_mha_page_table](build_trtllm_mha_page_table.md) |

...
| 65 | deepep_post_reorder | valid | completed(15876,e10,8/8,26.917125x新TB) | e10 26.917125x | no | 保留e10 26.917125；华为诊断缺逐case数据/同源执行入口，待昇腾入口对照E9/E10；e11不重试 | 2026-09-16 | [deepep_post_reorder](deepep_post_reorder.md) |

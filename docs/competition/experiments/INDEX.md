...
| 33 | per_token_group_quant_int8 | valid | 8/8 | e5 4.5707x | no | e7 昆仑瓦片已提交待评测(单变量,ZIP 0e05f32b);后续轴=1/4/8-group 按形分桶 | 2026-08-31 | [per_token_group_quant_int8](per_token_group_quant_int8.md) |

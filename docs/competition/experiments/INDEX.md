...
| 65 | deepep_post_reorder | invalid_correctness | submitted(13792,e2,评测中;e1=7/8 昆仑 uni_sram) | - | no | 七芯真实通过且读数强（华为 16.8990/海光 16.6416/天数 14.1316/A 13.8796/B 7.7532/沐曦 6.2860/燧原 1.3252）；昆仑 exec 0ms 服务线程卡死=崩溃族，重掷需用户当次明示授权或平台工单健康 worker rerun；S0 源 5573ffc 含 topk=0 退化分支 zeros 修复 | 2026-09-12 | [deepep_post_reorder](deepep_post_reorder.md) |
...
| 69 | fused_moe_dispatch_index | invalid_correctness | submitted(13769,e6,评测中;e5=7/8昆仑第5崩) | - | no | e6 kwargs 证伪（昆仑第6崩）；kernel 侧路径试尽，仅剩平台工单；七芯部分和 357.5 待命 | 2026-09-12 | [fused_moe_dispatch_index](fused_moe_dispatch_index.md) |

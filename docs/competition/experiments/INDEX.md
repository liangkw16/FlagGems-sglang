...
| 71 | gelu_tanh_and_mul | valid | submitted(13898,e2,评测中;TB e1 2.626x) | e1 2.62646667x | no | e1 valid 2.626 新 TB（天数+46%/华为+276%）；昆仑/燧原回退→vendor 冻结 1024 可再提；榜首 3.44 | 2026-09-13 | [gelu_tanh_and_mul](gelu_tanh_and_mul.md) |

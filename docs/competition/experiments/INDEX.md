...
| 69 | fused_moe_dispatch_index | valid | completed(e12-relaxed/sub16139,8/8,51.072975x；TB仍E10,51.3375x,排名5) | e10-generic-init 51.3375x | no | E13两路聚合已通过E10同分布代理筛选及11方法四源码release，ZIP就绪未提交；目标芯仍未验证 | 2026-09-16 | [fused_moe_dispatch_index](fused_moe_dispatch_index.md) |
...
| 74 | seqlens_expand | valid | completed(e4,8/8,20.1778x 新TB;海光28.78门兑现,沐曦+2.09) | e4 20.177775x | no | E11四请求group相对E4短q主桶mean1.261562/GM1.253914，15方法release通过，ZIP就绪未提交；目标芯未验证 | 2026-09-16 | [seqlens_expand](seqlens_expand.md) |

...
| 65 | deepep_post_reorder | invalid_correctness | completed(13792,e2,7/8;昆仑=间歇崩溃,BLOCK字节已备好) | - | no | 昆仑=间歇崩溃+需小 BLOCK 双条件；新 ZIP 重掷待健康窗口（同晨 T62 e5 正常判） | 2026-09-12 | [deepep_post_reorder](deepep_post_reorder.md) |

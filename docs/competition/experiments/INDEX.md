...
| 36 | selective_state_update | invalid_threshold | 8/8 | e22(correctness) 5.1200625x;昆仑0.0025xx | no | 分解昆仑validation编译/runtime并寻找数量级结构改写 | 2026-09-01 | [selective_state_update](selective_state_update.md) |

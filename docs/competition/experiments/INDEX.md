...
| 64 | deepep_permute | valid | submitted(e2=C1,评测中;e1 8/8 6.7478x) | e1 6.7478x | no | e2（燧原 grid 封顶 24）已发射；预注册燧原 ≥1.3x（目标轴 2.53→6.68 次优，值均值 +0.371） | 2026-09-12 | [deepep_permute](deepep_permute.md) |

...
| 76 | add3 | valid | completed(17393,e2,8/8,1.0564x新TB;燧原8192档+21%过门) | e2 | no | 燧原8192档兑现(0.755→0.914,门0.9刚过;纯streaming与T63 gather的8192回落成族边界对照);剩余=昆仑0.64→0.8/沐曦1.11→1.3无新假设;题边际递减,基本收官 | 2026-09-18 | [add3](add3.md) |
...
| 80 | fixup_zero_kv | valid | completed(17607,e7,8/8,197.25x<TB;保e4;沐曦warps轴窗口混淆关轴) | e4 200.920075x | no | 沐曦warps轴关闭(e6的219为窗口美化,e7同配置171.8,21%窗口摆动);燧原27.7/海光419今晚偏暖,慢窗最后一掷观察中;华为223回水位 | 2026-09-18 | [fixup_zero_kv](fixup_zero_kv.md) |
| 81 | fused_gate_sigmoid_mul_add | valid | completed(17611,e11,8/8,4.291x<TB;保e10;燧原单波消循环中性) | e10 | no | 燧原单波轴关闭(外层行循环非GCU瓶颈,1.943≈1.99);T81剩余结构缺口(燧原vs4.4/沐曦vs5.7)无新假设,等情报;TB 4.345守 | 2026-09-18 | [fused_gate_sigmoid_mul_add](fused_gate_sigmoid_mul_add.md) |

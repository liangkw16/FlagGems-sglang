...
| 61 | compute_src2dst | valid | completed(15835,e11,8/8,2.138475x新TB;e10/16468 metax wrapper-cast平台负向沐曦0.95) | e11 2.138475x | no | 保留E11团队最佳；Ascend cap/tail候选仅隔离留档，代理未提速；等待Ascend同源运行证据 | 2026-09-16 | [compute_src2dst](compute_src2dst.md) |
...
| 63 | create_flashinfer_kv_indices | valid | completed(e17-vendor-mix/sub16442,8/8,197.5424375x；未超TB E8) | e8 199.69521875x | no | E17八芯197.54244未超E8，停止重复组合；新splits两版NO-GO，保留199.69522 TB | 2026-09-16 | [create_flashinfer_kv_indices](create_flashinfer_kv_indices.md) |
...
| 67 | fill_padded_rows | valid | completed(e6/sub15376,8/8,4.295475x；TB仍E2 4.2969) | e2 4.2969x | no | E7仅负切片修复已过5方法双源码exact release与ZIP验签，按间隔单次提交；flat轴停止 | 2026-09-16 | [fill_padded_rows](fill_padded_rows.md) |

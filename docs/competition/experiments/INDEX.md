...
| 66 | dsv3_fused_a_gemm | valid | submitted(13371,e1,评测中;s0 8/8 2.7359x) | s0 2.735875x | no | e1（bf16 num_stages 2→4）候选就绪；榜差分散 5 芯（燧原+2.14/海光+2.78/沐曦+2.51）为全局配置轴；燧原 dot 形态风险轴（<64）未动 | 2026-09-12 | [dsv3_fused_a_gemm](dsv3_fused_a_gemm.md) |

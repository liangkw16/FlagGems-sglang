...
| 71 | gelu_tanh_and_mul | valid | completed(13898,e2,8/8,2.621x;TB e1 2.62646667x) | e1 2.62646667x | no | BLOCK=4096 对燧原 +44%（API 真值订正,此前结论反转）；e3 假设=燧原 8192 + 昆仑 no-loop（T61 no-loop 读 1.29 vs 本题 0.25） | 2026-09-13 | [gelu_tanh_and_mul](gelu_tanh_and_mul.md) |
...
| 73 | residual_gate_add | valid | completed(13905,e2,8/8,3.930x;TB s0 3.9518x) | s0 3.9518x | no | e2=grid封顶 enflame+18%（真实但有限）；e3=封顶+BLOCK4096 双杠杆（T71/T75 双证 4096 对燧原+44~71%） | 2026-09-13 | [residual_gate_add](residual_gate_add.md) |
...
| 75 | sigmoid_gate_mul | valid | completed(13878,e1,8/8,2.5107x;TB s0 2.538x) | s0 2.538x | no | e1 订正=4096 对燧原+71%（此前回退记载系转录错误,已作废）；e2=燧原8192+昆仑no-loop | 2026-09-13 | [sigmoid_gate_mul](sigmoid_gate_mul.md) |

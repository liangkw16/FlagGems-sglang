...
| 69 | fused_moe_dispatch_index | invalid_correctness | submitted(13359,e2,评测中) | - | no | e2 评测中（submission 13359）；裁决点=燧原是否解除 PassManager、华为 off-by-one 是否消失、昆仑新 ZIP 重掷 | 2026-09-12 | [fused_moe_dispatch_index](fused_moe_dispatch_index.md) |

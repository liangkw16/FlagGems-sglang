...
| 43 | causal_conv1d_update | valid | e16 7/8燧原复制仍编译失败；e17恢复燧原已验证形态并试昇腾tile | e13 6.545875x | no | E17昇腾STATE_BLOCK=min(64,pow2(state_len))；第二次候选门禁后单投，目标8.14x | 2026-09-07 | [causal_conv1d_update](causal_conv1d_update.md) |

...
| 69 | fused_moe_dispatch_index | valid | completed(e11-expert-grid/sub16063,8/8,49.699075x；TB仍E10,51.3375x,排名5) | e10-generic-init 51.3375x | no | E12 relaxed代理+7.02%、四源10/10 release通过，待单次提交；排序聚合独立筛选中 | 2026-09-16 | [fused_moe_dispatch_index](fused_moe_dispatch_index.md) |

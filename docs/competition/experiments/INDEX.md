...
| 33 | per_token_group_quant_int8 | valid | 8/8 | e7 4.5716x | no | e8 轴=GROUPS_TILE 1/4/8 按形分桶(41 算子核验建议);昆仑瓦片证伪已回滚 | 2026-08-31 | [per_token_group_quant_int8](per_token_group_quant_int8.md) |

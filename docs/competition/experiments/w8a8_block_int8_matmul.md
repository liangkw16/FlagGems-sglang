...
## E8 平台终态：**昆仑 fp16 dot 正确**，+4.4% 未过门（2026-09-09T06:22，sub 11640）

- 8/8 valid，avg 256.38（< e6r TB 258.05，窗口噪声内；华为 383.8 仍低位）。
- **探针答案：昆仑 fp16 张量核 dot 在平台完全正确**（145.77 vs ieee
  139.58，+4.4%）——历史"fp16 操作数错译"已被平台运行时修复（FlagTree
  #1099 修复链坐实）。**跨芯知识更新：昆仑 fp16 dot 从"禁用"改为
...
## e9r 终态（2026-09-10，sub 12370）：259.74 未超 TB

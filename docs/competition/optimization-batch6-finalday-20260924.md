...
- 多会话协同实录：HEAD 被并行 commit 移动两次，preflight 的
  receipt-source-commit 身份校验两次正确拦截错配提交（改用固定
...
| 题 | 开局 TB | 收盘 TB | Δ | 榜首 | 差距 |
| --- | ---: | ---: | ---: | ---: | ---: |
| T77 | 1100.74 | **1266.24** | +15.0% | 1747.50 | -27.5% |
| T80 | 569.13 | **581.23** | +2.1% | 660.06 | -11.9% |
| T92 | 341.31 | **344.60** | +1.0% | 416.58 | -17.3% |
| T89（并行） | 2.7198 | **2.8391** | +4.4% | 13569.1（彩票） | - |
| T90（并行） | 2.6857 | **2.8006** | +4.3% | 3.2440 | -13.7% |
